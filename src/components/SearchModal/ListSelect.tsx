      ...
      <StyledMenu ref={node as any}>
        ...
        {open && (
          <PopoverContainer show ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
            ...
            <Button variant='secondary' onClick={handleRemoveList} disabled={Object.keys(listsByUrl).length === 1}>
              Remove list
            </Button>
            {pending && (
              <Button variant='secondary' onClick={handleAcceptListUpdate}>Update list</Button>
            )}
          </PopoverContainer>
        )}
      </StyledMenu>
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      <Flex alignItems='center' mb='8px'>
        ...
        <Text color='textSubtle' fontSize='20px'>Add a list</Text>
      </Flex>
      <Flex mb='16px'>
        <SearchInput
          type="text"
        ...
        />
        <AddListButton color='secondary' onClick={handleAddList} disabled={!validUrl}>
          Add
        </AddListButton>
      </Flex>
      {/* {addError ? (
