...
export const usePriceBnbBusd = (): BigNumber => {
  ...
  // const farm = useFarmFromPid(pid);
  return ZERO // farm.tokenPriceVsQuote ? new BigNumber(farm.tokenPriceVsQuote) : ZERO
}
...
export const usePricePlockBusd = (): BigNumber => {
  ...
  // const farm = useFarmFromPid(pid);
  return ZERO; // farm.tokenPriceVsQuote ? bnbPriceUSD.times(farm.tokenPriceVsQuote) : ZERO;
}
